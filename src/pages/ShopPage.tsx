                  ...
                  <ScrollReveal key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <a 
                          href={`https://wa.me/917306379513?text=Hello, I'm interested in purchasing ${product.name}. Please provide more details.`}
                          target="_blank"
                  ...
                  <ScrollReveal key={product.id}>
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <a 
                          href={`https://wa.me/917306379513?text=Hello, I'm interested in purchasing the ${product.name} combo pack. Please provide more details.`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-full py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center"
                        >
