    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 pt-24 pb-16 px-4">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden" style={{ top: '60px', zIndex: 0 }}>
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white" style={{ top: '50px' }}></div>
        </div>
        
        <div className="max-w-4xl mx-auto relative z-10">
          {/* Profile Header Section */}
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
            <ScrollReveal>
          ...
          {message.text && (
            <div className={`mb-6 p-4 rounded-lg ${message.type === 'error' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'} animate-fade-in`}>
              {message.text}
            </div>
          )}
                      ...
                      <ScrollReveal delay={150}>
                        ...
                        <div className="pt-4 border-t border-gray-100">
                          ...
                          <div className="space-y-1.5">
                            <p className="font-medium">{profile.address_line1}</p>
                            {profile.address_line2 && <p className="font-medium">{profile.address_line2}</p>}
                        ...
                        <div className="pt-4 border-t border-gray-100">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              <p className="text-sm text-gray-500 mb-1">Preferred Language</p>
                              <p className="font-medium">{profile.preferred_language}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500 mb-1">Marketing Preferences</p>
                              <p className="font-medium">
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="flex justify-end space-x-4 mt-8">
                              ...
                              <button
                                ...
                                onClick={handleSave}
                                disabled={saving}
                                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-lg hover:shadow-md transition-all"
                              >
                  ...
                  <div className="p-6">
                    ...
                    <ul className="space-y-3">
                      <li className="flex justify-between">
                        ...
                        <span className="font-medium">{profile?.created_at && new Date(profile.created_at).toLocaleDateString('en-US', { year: 'numeric', month: 'short' })}</span>
                      </li>
                      <li className="flex justify-between">
                        <span className="text-gray-600">Last Update</span>
                        <span className="font-medium">{profile?.updated_at && new Date(profile.updated_at).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}</span>
                      </li>
                      <li className="flex justify-between">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                  <div className="p-6">
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <a href="/" className="mt-4 inline-block text-blue-600 hover:underline font-medium">
                        Browse Products
                      </a>
                    </div>
                  </div>
