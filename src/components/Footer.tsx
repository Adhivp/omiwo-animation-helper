...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-white dark:bg-gray-900 relative">
          ...
          <div className="md:col-span-1">
            <ScrollReveal delay={200}>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="mailto:info@omiwo.com" className="text-foreground/70 hover:text-omiwo-blue dark:hover:text-blue-400 transition-colors">
                    info@omiwo.com
                  </a>
                </li>
                <li>
                  <a href="tel:+917306379513" className="text-foreground/70 hover:text-omiwo-blue dark:hover:text-blue-400 transition-colors">
                    +91 73063 79513
                  </a>
                </li>
              </ul>
        ...
        <ScrollReveal delay={400}>
          <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-foreground/60 hover:text-omiwo-blue dark:hover:text-blue-400 transition-colors">
      ...
      <Dialog open={isWhatsappOpen} onOpenChange={setIsWhatsappOpen}>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-800 rounded-xl p-0 shadow-2xl">
          <div className="bg-green-500 dark:bg-green-600 p-4 rounded-t-xl">
